<div>
    <div class="title d-flex justify-content-between">
        <h2 class="text-uppercase">{{__('list news')}}</h2>
        <a href="{{route('backend.berita.register-berita')}}" class="text-capitalize"><span class="fa fa-plus"></span> {{__('new-data')}}</a>
    </div>
    ...
    <table class="table table-bordered table-hover">
        ...
        @forelse ($beritas as $index=>$item)
            <tr>
                ...
                <td>{{\App\Helper\BoedySoft::trans($item->kategoriBerita->kategoris) }}</td>
                ...
                <td>
                    <div class="d-flex justify-content-between">
                        <a href="{{route('backend.berita.edit-berita',$item->id)}}"><span class="fa fa-edit"></span></a>
