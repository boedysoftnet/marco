<div>
    <div class="title d-flex justify-content-between">
        <h2 class="text-uppercase">{{__('list benners')}}</h2>
        <a href="{{route('backend.benner.register-benner')}}" class="text-capitalize"><span class="fa fa-plus"></span> {{__('new-data')}}</a>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-between">
                        <a href="{{route('backend.benner.edit-benner',$item->id)}}"><span class="fa fa-edit"></span></a>
