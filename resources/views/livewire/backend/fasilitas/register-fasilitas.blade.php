<div wire:ignore>
    <h2 class="text-uppercase">{{__('register facilites')}}</h2>
    <hr>
        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <div class="tab-pane fade {{$index==0?'show active':''}}" id="nav-{{$item->slug}}"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" wire:model="data.fasilitas.{{$item->slug}}" class="form-control">
                                </div>
                            </div>
                ...
                <div>
                    ...
                    <a href="{{route('backend.fasilitas.daftar-fasilitas')}}" class="btn btn-primary"><span
